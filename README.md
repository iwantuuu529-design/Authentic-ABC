...
- **Key Features**:
  ...
  - **সরাসরি হোয়াটসঅ্যাপ যোগাযোগ**: ইউজার ড্যাশবোর্ডের নিচে-ডানে সবসময় ভাসমান বৃত্তাকার WhatsApp বাটন (অ্যাডমিন প্যানেলে দেখায় না) — অ্যাডমিন-সেটিংসের `support_whatsapp` নম্বরে সরাসরি লিংক করে, ধীর "watery" অ্যামবিয়েন্ট রিং-পালস সবসময় চলে এবং হোভারে জেলি-সদৃশ বর্ডার-রেডিয়াস মরফ + দ্রুত রিপল-ব্লুম ইফেক্ট দেখায়
